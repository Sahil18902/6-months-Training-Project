...
class Application:
    ...
    def action_call(self) :
        ...
        #self.photo1 = tk.PhotoImage(file='Pictures/karan.png')
        self.w1 = tk.Label(self.root1)
        self.w1.place(x = 20, y = 105)
        self.tx6 = tk.Label(self.root1)
        self.tx6.place(x = 50,y = 250)
        self.tx6.config(text = "Nimish Budhiraja \n 2004631", font = ("Courier",15,"bold"))

        # self.photo2 = tk.PhotoImage(file='Pictures/manav.png'),, image = self.photo2
        self.w2 = tk.Label(self.root1)
        self.w2.place(x = 200, y = 105)
        self.tx2 = tk.Label(self.root1)
        self.tx2.place(x = 290,y = 250)
        self.tx2.config(text = "Sahil Sharma \n2004657", font = ("Courier",15,"bold"))

        
        # self.photo3 = tk.PhotoImage(file='Pictures/manjot.png')
        self.w3 = tk.Label(self.root1)
        self.w3.place(x = 380, y = 105)
        self.tx3 = tk.Label(self.root1)
        self.tx3.place(x = 490,y = 250)
        self.tx3.config(text = "Sanyam Garg\n2004659", font = ("Courier",15,"bold"))
